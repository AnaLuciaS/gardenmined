...
class Cursor:
    ...
    def atualizar(self): 
        self.y += (self.to_y - self.y) / 1.0# aumenta ou diminui a velocidade do cursor
...
class Menu:
    ...
    def __init__(self, opciones):
        ...
        x = 335 # Alinha a direita ou equerda o cursor
...
def comecar_novo_jogo():
    ...
    fundo = pygame.image.load("Menu" + os.sep + "jogar.png").convert()
...
def creditos():
    ...
    screen = pygame.display.set_mode ((800, 600))
    fundo = pygame.image.load("Menu" + os.sep + "fundo_menu2.png").convert()
...
def sair_do_jogo():
    ...
    pressionou = False
    pygame.font.init()
    fundo = pygame.image.load("Menu" + os.sep + "sair_jogo.png").convert()
