...
MEDIUM = pygame.font.Font("Imagens_jogo" + os.sep + "CHICK___.ttf", 24)
som_tocando = True


#Carregando 

img_flag = pygame.image.load("Imagens_jogo" + os.sep + "img_flor1.png")
img_spaces = multiimageload(["Imagens_jogo" + os.sep + "img_1.png", "Imagens_jogo" + os.sep + "img_2.png", "Imagens_jogo" + os.sep + "img_3.png", "Imagens_jogo" + os.sep + "img_4.png", "Imagens_jogo" + os.sep + "img_5.png", "Imagens_jogo" + os.sep + "img_6.png", "Imagens_jogo" + os.sep + "img_7.png", "Imagens_jogo" + os.sep + "img_8.png", "Imagens_jogo" + os.sep + "img_bomba1.png"])
img_fundoo = pygame.image.load("Imagens_jogo" + os.sep + "a.png")
som_on = pygame.image.load("Imagens_jogo" + os.sep + "Som.png")
som_off = pygame.image.load("Imagens_jogo" + os.sep + "Sem_som.png")
img_voce_venceu = pygame.image.load("Imagens_jogo" + os.sep + "ganhar.png")
img_voce_perdeu = pygame.image.load("Imagens_jogo" + os.sep + "perder.png")
voltar_menu = pygame.image.load("Imagens_jogo" + os.sep + "seta_voltar.png")
bordas = pygame.image.load("Imagens_jogo" + os.sep + "bordas.png")
nome = pygame.image.load("Imagens_jogo" + os.sep + "nome.png")
medio = pygame.image.load("Imagens_jogo" + os.sep + "n_2.png")



#carregando sons

som_bomba = pygame.mixer.Sound("Sons" + os.sep + "explode.wav")
...
class Main(object):
    def __init__(self,altura, largura, bomba):
        self.startgame(altura, largura, bomba, "Garden Mined")
        self.mouseleft = "up"
        self.mouseright = "up"
        self.mode = 1
    ...
    def loop(self):
        ...
        medio.blit(voltar_menu, (0, 350))
        medio.blit(nome, (600, 50))
        medio.blit(som_on, (0, 150))
        self.screen.blit(medio, (0, 0))
            ...
            for b in range(self.game.n):
                ...
                if self.game.seenboard[a][b] == 1:          
                   pygame.display.update(screen.blit(img_spaces[self.game.board[a][b]], (a * 32 + 64 , b * 32 + 32)))
                    ...
                    planoFundo = pygame.image.load("Imagens_jogo" + os.sep + "a.png").convert()
