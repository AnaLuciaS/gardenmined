...
class Main(object):
    def __init__(self, bomba):
        self.startgame(15, 15, bomba, "Garden Mined - Facil")
        self.mouseleft = "up"
        self.mouseright = "up"
        self.mode = 1
    ...
    def loop(self):
        ...
        self.screen.blit(bordas, (550, 100))
    ...
    def draw(self):
        ...
        for a in range(self.game.m):
            for b in range(self.game.n):
                if self.mode == 2:
                    pygame.display.update(screen.blit(img_voce_venceu, (150, 150)))
                elif self.mode == 3:
                    pygame.display.update(screen.blit(img_voce_perdeu, (150, 150)))
