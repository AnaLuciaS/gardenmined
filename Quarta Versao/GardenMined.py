...
def escolher_niveis():
    ...
    class Menu:
        ...
        def __init__(self, opciones):
            ...
            self.opcoes = []
            fonte = pygame.font.Font("Menu" + os.sep + "ch.ttf", 50)
            x = 210 
            y = 260
            paridad = 1
    ...
    if __name__ == '__main__':
        ...
        sair_tela = pygame.image.load("resources" + os.sep + "seta_voltar.png")
